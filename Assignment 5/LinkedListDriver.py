...
#print('calling pop(-1). Should return Snape: {}, and the size should be 4: {}'.format(names.pop(-1), names.size()))
...
print('calling pop(10). Should return None: {}, and the size should be 2: {}'.format(names.pop(10), names.size()))
print('calling pop(-10). Should return None: {}, and the size should be 2: {}'.format(names.pop(-10), names.size()))
print('calling pop(Hermione). Should return None: {}, and the size should be 2: {}'.format(names.pop('Hermione'), names.size()))
...
names.remove('asd')
print('called remove(\'asd\'). Does not return anything, but list size should be 2:', names.size())
